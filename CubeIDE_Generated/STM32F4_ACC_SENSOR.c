...
void initOrientation() {
  ...
  i2c1_pisiRegister(0x19, 0x23, 0x10);  // nastavi posodobitev samo ko se prebere vrednost ter visoko locljivost
}
...
/* Configure the peripherals common clocks */
  ...
  while (1)
  {
	  ...
	  if(temp == 1){
		  ...
		  temp2 = 0;
		  temp3 = 0;
		  i2c1_beriRegistre(0x19, 0x28,(uint8_t*)&temp2, 8);
		  i2c1_beriRegistre(0x19, 0x29,(uint8_t*)&temp3, 8);

		  meritev[2] = (temp3 << 8 | temp2);

		  i2c1_beriRegistre(0x19, 0x2A,(uint8_t*)&temp2, 8);
		  i2c1_beriRegistre(0x19, 0x2B,(uint8_t*)&temp3, 8);

		  meritev[3] = (temp3 << 8 | temp2);

		  i2c1_beriRegistre(0x19, 0x2C,(uint8_t*)&temp2, 8);
		  i2c1_beriRegistre(0x19, 0x2D,(uint8_t*)&temp3, 8);
		  ...
		  koncna[3] = (temp3 << 8 | temp2);
		  //koncna[3] = (float)(temp3 | temp2 << 8);

		  //sprintf(temp1, "{\"GYR\":0, \"X\":%.3f\n\r", koncna[0]);
		  sprintf(temp1, "{\"ACC\":%d, \"X\":%.3f, \"Y\":%.3f, \"Z\":%.3f}\n\r",counter , (float)((koncna[1]*0.122072)/1000),
																						  (float)((koncna[2]*0.122072)/1000),
																						  (float)((koncna[3]*0.122072)/1000));
		  counter++;
